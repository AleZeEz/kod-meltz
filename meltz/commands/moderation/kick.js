module.exports = ({
   ...
   $onlyIf[$mentioned[1]!=$authorID;Nie mozesz wyrzucic samego siebie!]
   $onlyIf[$mentioned[1]!=;Musisz oznaczyc kogo chcesz wyrzucic!]
   ...
   $onlyPerms[kick;{title:Error!}{color:fa4a4a}{description:Nie masz wystarczajacych uprawnien do wykonania tej komendy! (KICK MEMBERS)}]
