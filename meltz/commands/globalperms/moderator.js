module.exports = ({
    name: "globalperms",
    code: `$setGlobalUserVar[globalperms;2;$message[2]]
    $author[Sukces!;https://cdn.discordapp.com/emojis/767709295265316865.png?v=1]
    $description[Zmieniono poziom globalnych uprawnien dla \`$username[$message[2]]\` na \`02\` (\`MODERATOR\`)] $color[2add15]
